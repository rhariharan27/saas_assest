...
class TenantSeeder extends Seeder
{
  ...
  public function run(): void
  {
    ...
    $tenant1 = Tenant::create(['id' => 'asset-tenant', 'name' => 'Cygnuz']);
    ...
    $tenant1->domains()->create(['domain' => 'testdomain1.' . env('PRIMARY_DOMAIN')]);
    $tenant1->domains()->create(['domain' => 'testdomain1.' . 'localhost']);

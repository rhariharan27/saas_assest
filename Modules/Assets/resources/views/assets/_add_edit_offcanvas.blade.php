...
<div class="offcanvas offcanvas-end" tabindex="-1" id="assetOffcanvas" aria-labelledby="assetOffcanvasLabel" style="width: 650px;"> {{-- Wider offcanvas for more fields --}}
  <div class="offcanvas-header">
    <h5 id="assetOffcanvasLabel" class="offcanvas-title">{{ __('Add Asset') }}</h5>
    ...
    <form class="add-edit-asset-form pt-0" id="assetForm" onsubmit="return false;" >
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          <label class="form-label" for="assetName">{{ __('Asset Name') }} <span class="text-danger">*</span></label>
          <input type="text" class="form-control" id="assetName" placeholder="e.g., HR Laptop 05" name="name" required />
          <div class="invalid-feedback"></div>
        </div>
        {{-- Asset Tag --}}
        <div class="col-md-6 mb-3">
          <label class="form-label" for="assetTag">{{ __('Asset Tag') }} <span class="text-danger">*</span></label>
      ...
      <div class="row">
        {{-- Category --}}
        <div class="col-md-6 mb-3">
          <label class="form-label" for="asset_category_id">{{ __('Category') }}</label>
        ...
        {{-- Serial Number --}}
        <div class="col-md-6 mb-3">
          <label class="form-label" for="serialNumber">{{ __('Serial Number') }}</label>
      ...
      <div class="row">
        ...
        {{-- Purchase Cost --}}
        <div class="col-md-6 mb-3">
          <label class="form-label" for="purchase_cost">{{ __('Purchase Cost') }}</label>
      ...
      <div class="row">
        ...
        {{-- Warranty Expiry --}}
        <div class="col-md-6 mb-3">
          <label class="form-label" for="warranty_expiry_date">{{ __('Warranty Expiry') }}</label>
      ...
      {{-- Location --}}
      <div class="mb-3">
        <label class="form-label" for="location">{{ __('Current Location') }}</label>
      ...
      <div class="mt-4">
        <button type="submit" class="btn btn-primary me-sm-3 me-1 data-submit" id="submitAssetBtn">{{ __('Submit') }}</button>
